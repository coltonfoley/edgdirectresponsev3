...
export default defineType({
  ...
  groups: [
    ...
    { name: 'showroom', title: 'Showroom Section' },
    ...
    defineField({
      ...
      fields: [
        defineField({
          ...
          title: 'Section Title',
          type: 'string',
          initialValue: 'Visit Our Spring Grove Showroom',
        }),
        defineField({
          name: 'subtitle',
          title: 'Description',
          type: 'text',
          initialValue: "The only showroom in the region where you can see motorized pergolas, screens, and glass enclosures running side by side.",
        }),
        defineField({
          name: 'address',
          title: 'Address',
          type: 'string',
          initialValue: '1802 Holian Drive, Spring Grove, IL 60081',
        }),
        defineField({
          name: 'hours',
          title: 'Hours',
        ...
        defineField({
          ...
          type: 'image',
          options: { hotspot: true },
          description: 'Photo of the showroom interior or exterior. Recommended: 16:9 or 4:3 ratio.',
        }),
      ],
    }),
    defineField({
