    ...
    <main className="bg-background min-h-screen">
      ...
      <Section className="bg-zinc-900 pt-32 pb-20 text-white">
        <Container>
          {/* Breadcrumb */}
          <div className="mb-6">
            <Breadcrumb items={[{ label: 'Showroom' }]} />
          </div>
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <div className="flex flex-col gap-4 sm:flex-row">
                ...
                <Link
                  href="https://maps.google.com/?q=1802+Holian+Drive+Spring+Grove+IL+60081"
                  className="inline-flex h-12 items-center justify-center rounded-md border border-white/20 bg-transparent px-8 text-lg font-medium text-white transition-colors hover:bg-white/10"
                >
                  Get Directions
                </Link>
              </div>
            ...
            {/* Showroom Hero Image */}
            <div className="relative aspect-video overflow-hidden rounded-2xl border border-white/10 bg-zinc-800">
              <Image
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <div className="bg-background rounded-lg border p-6">
              ...
              <p className="text-muted-foreground text-sm">
                Full-size demo unit with rotating louvers, integrated lighting,
                and heaters.
              </p>
            </div>
            <div className="bg-background rounded-lg border p-6">
              ...
              <p className="text-muted-foreground text-sm">
                See the track systems, mesh options, and wind retention
            ...
            <div className="bg-background rounded-lg border p-6">
              ...
              <p className="text-muted-foreground text-sm">
                Test the heat output of our infrared heaters and unified control
                systems.
              </p>
            </div>
          </div>
