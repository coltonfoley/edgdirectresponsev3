...
export default function PergolasPage() {
    const serviceSchema = generateServiceSchema({
        ...
        description: "Motorized aluminum louvers that rotate from full sun to full shade—and close completely for rain protection.",
    ...
    return (
        <main className="min-h-screen">
                        ...
                        <div className="lg:sticky lg:top-40 space-y-6">
                            <div>
                                ...
                                <p className="text-xl text-edg-gray-text dark:text-gray-400 leading-relaxed">
                                    Custom motorized aluminum pergolas with rotating louvers from full sun to full shade—and close
            ...
            {/* ========== COMMERCIAL BRIDGE ========== */}
            <Section className="py-20 bg-zinc-50 dark:bg-zinc-900 border-t border-black/5 dark:border-white/5">
                <Container>
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div>
                            <span className="text-edg-brand-text dark:text-edg-brand font-bold uppercase tracking-wider text-xs mb-2 block">
                            ...
                            <p className="text-lg text-muted-foreground mb-6">
                                We specialize in high-ROI outdoor dining spaces for the hospitality industry.
                                From country clubs to rooftop bars, get systems designed for commercial durability.
                            </p>
                            <Link href="/commercial/chicago-hospitality-outdoor-living">
                                <Button variant="secondary" size="lg" className="rounded-full border border-black/10 dark:border-white/10 bg-transparent hover:bg-black/5 dark:hover:bg-white/5">
                                    View Commercial Solutions <ArrowRight className="ml-2 h-5 w-5" />
                                </Button>
                            </Link>
                        </div>
