                        ...
                        <div className="lg:sticky lg:top-40 space-y-6">
                            <div>
                                ...
                                <p className="text-xl text-edg-gray-text dark:text-gray-400 leading-relaxed">
                                    Wind-rated sun shades for patios that block 80%+ of heat and glare while
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-lg text-muted-foreground mb-6">
                                Reduce cooling costs and increase dining comfort for your business.
                                Our heavy-duty systems are built for restaurants, hotels, and country clubs.
                            </p>
