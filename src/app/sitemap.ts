...
export default function sitemap(): MetadataRoute.Sitemap {
    ...
    const routes = [
        ...
        { url: '/service-areas/sanibel-outdoor-living/louvered-pergolas', priority: 0.8 },
        { url: '/service-areas/sanibel-outdoor-living/zoning-guide', priority: 0.7 },
