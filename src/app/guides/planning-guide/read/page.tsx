...
export const metadata: Metadata = {
    ...
    description: "The complete 2026 homeowner's guide to outdoor living systems. Louvered pergolas, motorized shades, and frameless glass for Chicago-Milwaukee homes.",
    alternates: {
