...
export const metadata: Metadata = {
    ...
    description: "Premium motorized pergolas, exterior shades, and glass enclosures for Chicago's North Shore. Serving Wilmette, Winnetka, Glencoe, Kenilworth, Northbrook & Northfield. Design review expertise.",
    openGraph: {
        title: "North Shore Chicago | Pergolas & Outdoor Living | EDG",
        description: "Premium outdoor living systems for North Shore properties. Historic district expertise, professional installation.",
    },
};

const communities = [
    { name: "Wilmette", note: "Design review" },
    { name: "Winnetka", note: "Design review" },
    { name: "Glencoe", note: "Design review" },
    { name: "Kenilworth", note: "Design review" },
...
const localConsiderations = [
    {
        title: "Design Review Boards",
        description: "Winnetka, Wilmette, Glencoe, and Kenilworth have architectural review requirements. We prepare submissions that address their criteria and have successfully navigated approvals throughout the North Shore.",
    },
    {
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {communities.map((community) => (
                            ...
                            >
                                ...
                                {community.note && (
                                    <span className="block text-xs text-edg-brand mt-1">{community.note}</span>
                                )}
                            </div>
                        ))}
                    </div>
                ...
                <Container>
                    <div className="max-w-4xl mx-auto">
                        ...
                        <p className="text-xl mb-8 text-edg-dark/80">
                            North Shore communities are known for their architectural standards. We don't just 
                            meet those standards—we've learned how to work with each village's review process 
                            to get approvals efficiently while protecting your design vision.
                        </p>
                        <div className="grid md:grid-cols-2 gap-6">
                            {[
                                "Prepare submissions that address review criteria upfront",
                                "Coordinate with village staff before formal submission",
                                "Present options that balance aesthetics and function",
                                "Handle revisions and resubmissions if needed",
                            ].map((item) => (
                ...
                <Container>
                    <div className="max-w-3xl mx-auto text-center">
                        <blockquote className="text-2xl md:text-3xl font-medium leading-relaxed mb-8">
                            "The Winnetka design review process can be daunting. EDG handled everything—the 
                            submission, the meeting, even a requested revision. Our pergola was approved 
                            without us attending a single hearing."
                        </blockquote>
                        <div>
                ...
                <Container>
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <p className="text-xl mb-8 text-gray-300">
                            Schedule a consultation. We'll assess your property, discuss design review 
                            requirements if applicable, and show you what's possible.
                        </p>
