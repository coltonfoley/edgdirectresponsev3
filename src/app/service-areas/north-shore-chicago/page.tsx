            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "description": "Premium motorized pergolas, exterior shades, and glass enclosures for Chicago's North Shore estates.",
                        "provider": {
                        ...
                        <div className="max-w-4xl mx-auto">
                            <div className="text-center mb-12">
                                ...
                                <p className="text-lg text-muted-foreground">
                                    We believe in transparency. Here are typical investment ranges for North Shore projects, including design, engineering, and installation.
                                </p>
                            </div>
                            <div className="grid md:grid-cols-2 gap-8">
                                <div className="bg-white dark:bg-black p-8 rounded-2xl border border-black/5 dark:border-white/10">
                                    <h3 className="text-xl font-bold mb-2">Louvered Pergolas</h3>
                                    <div className="text-3xl font-bold text-edg-brand mb-4">$35k - $85k+</div>
                                    <p className="text-sm text-edg-gray-text dark:text-gray-400 mb-4">
                                        Range varies by size (e.g., 12x12 vs 20x20), amenities (heaters, lights, screens), and wind-rating requirements.
                                    </p>
                                    <ul className="space-y-2 text-sm">
                                        <li className="flex items-center gap-2">
                                            <CheckCircle2 className="h-4 w-4 text-emerald-500" /> Full motorized control
                                        </li>
                                        <li className="flex items-center gap-2">
                                            <CheckCircle2 className="h-4 w-4 text-emerald-500" /> Integrated LED lighting
                                        </li>
                                    </ul>
                                </div>
                                <div className="bg-white dark:bg-black p-8 rounded-2xl border border-black/5 dark:border-white/10">
                                    <h3 className="text-xl font-bold mb-2">Motorized Screen Projects</h3>
                                    <div className="text-3xl font-bold text-edg-brand mb-4">$8k - $25k+</div>
                                    <p className="text-sm text-edg-gray-text dark:text-gray-400 mb-4">
                                        For existing porches or pergolas. Price depends on number of openings, width of spans, and integration complexity.
                                    </p>
                                    <ul className="space-y-2 text-sm">
                                        <li className="flex items-center gap-2">
                                            <CheckCircle2 className="h-4 w-4 text-emerald-500" /> 10+ year fabric warranty
                                        </li>
                                        <li className="flex items-center gap-2">
                                            <CheckCircle2 className="h-4 w-4 text-emerald-500" /> Smart home compatible
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <p className="text-center text-sm text-muted-foreground mt-8">
                                *Every project is unique. These are historical averages for the North Shore area.
                            </p>
                        </div>
                    </Container>
                </Section>
