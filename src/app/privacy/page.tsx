...
export const metadata: Metadata = {
  ...
  description:
    'Privacy Policy for EDG Patio & Shade. Learn how we collect, use, and protect your information.',
  alternates: {
    canonical: '/privacy',
  },
};
          ...
          <div className="max-w-3xl">
            ...
            <div className="prose prose-zinc dark:prose-invert text-muted-foreground max-w-none space-y-8">
              ...
              <section className="space-y-4">
                ...
                <p>
                  Welcome to <strong>EDG Patio & Shade</strong> ("we," "our," or
                  "us"). We are committed to protecting your privacy and
                  ensuring that your personal information is handled in a safe
              ...
              <section className="space-y-4">
                ...
                <ul className="list-disc space-y-2 pl-6">
                  <li>
                    ...
                    when you choose to participate in various activities related
                    to the website, such as online chat and message boards.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    collect when you purchase, order, return, exchange, or
              ...
              <section className="space-y-4">
                ...
                <ul className="list-disc space-y-2 pl-6">
                  ...
                  <li>
                    Send you newsletters, marketing communications, and other
