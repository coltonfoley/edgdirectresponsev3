    ...
    */
    {
        ...
        description: "A 5-acre estate adds a snow-load engineered outdoor living room that respects the strict impermeable coverage limits of the Village.",
        challenge: "The homeowners wanted a large covered structure for their pool deck but were approaching the 50% impermeable coverage limit. They also needed a structure that could withstand the heavy snow loads and high winds on their open estate property without looking industrial.",
        solution: "We designed a heavy-duty extruded aluminum system with a custom architectural cornice to match the estate's traditional style. The footprint was carefully engineered to maximize usable space while staying within the Village's coverage cap. Integrated heaters allow for use during holiday parties.",
        results: [
        ...
        testimonial: {
            quote: "We were worried about zoning, but EDG handled everything. The pergola handles the snow beautifully and looks like it was built with the house.",
