                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-gray-400 text-sm">
                                <li>
                                    <Link href="/service-areas/lake-county-il" className="hover:text-edg-brand transition-colors">
                                        Lake County, IL
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/service-areas/mchenry-county-il" className="hover:text-edg-brand transition-colors">
                                        McHenry County, IL
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/service-areas/north-shore-chicago" className="hover:text-edg-brand transition-colors">
                                        North Shore Chicago
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/service-areas/barrington-il" className="hover:text-edg-brand transition-colors">
                                        Barrington Area
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/service-areas/naperville-il" className="hover:text-edg-brand transition-colors">
                                        Naperville & West Suburbs
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/service-areas/oak-brook-il" className="hover:text-edg-brand transition-colors">
                                        Oak Brook & Hinsdale
                                    </Link>
                                </li>
                                <li>
                                ...
                                <li>
                                    <Link href="/service-areas/lake-geneva-wi" className="hover:text-edg-brand transition-colors">
                                        Lake Geneva, WI
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/service-areas/sanibel-outdoor-living" className="hover:text-edg-brand transition-colors">
                                        Sanibel / Captiva, FL
                                    </Link>
                                </li>
                            </ul>
