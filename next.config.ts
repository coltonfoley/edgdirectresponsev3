...
const contentSecurityPolicy = [
  "default-src 'self'",
  "script-src 'self' 'unsafe-inline' https://www.googletagmanager.com https://www.google-analytics.com https://googleads.g.doubleclick.net https://www.googleadservices.com https://*.hs-scripts.com https://*.hs-analytics.net https://*.hs-banner.com https://*.hsforms.net https://*.hsadspixel.net https://*.hscollectedforms.net https://js.usemessages.com https://*.clarity.ms https://static.klaviyo.com https://static-tracking.klaviyo.com https://assets.apollo.io",
  "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
  "img-src 'self' data: blob: https://images.unsplash.com https://image.pollinations.ai https://www.googletagmanager.com https://www.google-analytics.com https://googleads.g.doubleclick.net https://stats.g.doubleclick.net https://www.google.com https://www.googleadservices.com https://*.hubspot.com https://*.hsforms.com https://*.hsforms.net https://*.clarity.ms https://*.bing.com https://*.klaviyo.com https://*.apollo.io",
  "font-src 'self' data: https://fonts.gstatic.com",
  "connect-src 'self' https://*.supabase.co https://api.resend.com https://vitals.vercel-insights.com https://www.googletagmanager.com https://www.google-analytics.com https://*.google-analytics.com https://analytics.google.com https://googleads.g.doubleclick.net https://stats.g.doubleclick.net https://www.google.com https://www.googleadservices.com https://*.hubspot.com https://api.hubapi.com https://*.hsforms.com https://*.hsforms.net https://*.hscollectedforms.net https://*.clarity.ms https://*.klaviyo.com https://*.apollo.io https://aplo-evnt.com",
